<?php
/**
* Collection of functions can be used pods repeater field database
*
* @package fs_pods_repeater_field
*/
class fs_pods_repeater_field_db {

	public static $keys_arr = array( 
							  'FSrf_parent_pod_id'	=> array( 'type' => 'int(11)', 		 'settings' => 'NOT NULL', 'default' => '' ), 
							  'FSrf_parent_post_id'	=> array( 'type' => 'int(11)',	 	 'settings' => 'NOT NULL', 'default' => '' ), 
							  'FSrf_pod_field_id'	=> array( 'type' => 'int(11)', 	 	 'settings' => 'NOT NULL', 'default' => '' ), 							  
							  'FSrf_order' 			=> array( 'type' => 'text', 	 	 'settings' => 'NOT NULL', 'default' => '' ),
							  'FSrf_created' 		=> array( 'type' => 'DATETIME',  	 'settings' => 'NOT NULL', 'default' => 'DEFAULT "0000-00-00 00:00:00"' ),
							  'FSrf_modified' 		=> array( 'type' => 'DATETIME',  	 'settings' => 'NOT NULL', 'default' => 'DEFAULT "0000-00-00 00:00:00"' ),		  
							  'FSrf_modified_author' => array( 'type' => 'int(11)', 	 	 'settings' => 'NOT NULL', 'default' => '' ), 
							  'FSrf_author' 			=> array( 'type' => 'int(11)', 	 	 'settings' => 'NOT NULL', 'default' => '' ),		  
							  'FSrf_trash' 			=> array( 'type' => 'int(1)', 	 	 'settings' => 'NOT NULL', 'default' => 'DEFAULT 0' ),	
						  ); 
	/**
		...
		if( $parent_pod ){
			foreach( $parent_pod->fields as $field_arr ){
				...
				if( $field_arr['id'] == $fieldID_int ){
					...
					if( isset( $field_arr['options']['fsrepeaterfield_apply_admin_columns'] ) && $field_arr['options']['fsrepeaterfield_apply_admin_columns'] == 1 ){
